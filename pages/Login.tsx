        ...
        <div className="p-10 md:p-14">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-black text-slate-900 tracking-tighter mb-2">
              {isRegister ? 'Intake Portal' : 'Clinical Access'}
            </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {step === 1 ? (
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Clinical Identifier</label>
                ...
                <div className="space-y-1">
                  <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Access Protocol Key</label>
              ...
              <div className="space-y-5 animate-in slide-in-from-right-8 duration-500">
                 ...
                 <div className="space-y-1">
                   <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Genotype Configuration</label>
            ...
            >
              <span className="relative z-10">
                {loading ? 'Initializing Protocol...' : 
                 isRegister && step === 1 && role === UserRole.PATIENT ? 'Configure Medical Profile' : 
                 isRegister ? 'Authorize Identity' : 'Establish Secure Connection'}
              </span>
            </button>
          </form>
          ...
          <div className="mt-12 pt-10 border-t border-slate-50 text-center">
            ...
            >
              {isRegister ? 'Return to Verification Node' : 'Initialize New Clinical Identity'}
            </button>
          </div>
        </div>
      </div>
