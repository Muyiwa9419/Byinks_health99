...
import ConsultantProfile from './pages/ConsultantProfile.tsx';
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const systemChannel =
      ClinicalAPI.subscribeToGlobalSystem(
        (payload) => {
