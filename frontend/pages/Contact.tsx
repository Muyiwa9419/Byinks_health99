          ...
          <div className="animate-in fade-in slide-in-from-left-8 duration-700">
            ...
            <div className="space-y-10">
              <div className="flex items-start space-x-6">
                ...
                <div>
                  <h4 className="text-lg font-black text-slate-900 mb-1">Medical Centers</h4>
                  <p className="text-slate-500 font-medium">LASUTH</p>
                  <p className="text-slate-500 font-medium">LUTH</p>
                  <p className="text-slate-500 font-medium">Federal Ministry of Health</p>
                  <p className="text-slate-500 font-medium">Evercare Hospital</p>
                  <p className="text-slate-500 font-medium">St Nicholas etc</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-6">
                ...
                <div>
                  ...
                  <p className="text-slate-500 font-medium">+234 8023614681 (Main Line)</p>
                  <p className="text-red-500 font-black text-xs uppercase tracking-widest mt-1">Emergency: +234 8023614681</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-6">
                ...
                <div>
                  ...
                  <p className="text-slate-500 font-medium">care@ekomedical.org</p>
                </div>
              </div>
            </div>
          </div>
