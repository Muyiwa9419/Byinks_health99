...
const HospitalHome: React.FC = () => {
  ...
  {
    name: 'Eko Medical',
    category: 'Telemedical',
    description: 'Access professional healthcare consultations remotely through our telemedical services.',
    icon: '💻',
  },
  {
    name: 'Medical Consumables',
    category: 'Medical Supplies',
    description: 'Reliable medical consumables and essential supplies for healthcare needs.',
    icon: '🩺',
  },
  {
    name: 'Health Maintenance Organization',
    category: 'Healthcare Management',
    description: 'Comprehensive healthcare management and support through our HMO services.',
    icon: '🏥',
  },
  {
    name: 'Pharmaceutical Deliveries',
    category: 'Pharmacy',
    description: 'Convenient and reliable delivery of pharmaceutical products directly to you.',
    icon: '💊',
  },
  {
    name: 'Specialized Cosmetics for Surgery',
    category: 'Surgical Care',
    description: 'Specialized cosmetic products designed to support surgical and post-surgical care.',
    icon: '🧴',
  },
  {
    name: 'Medical Transcription',
    category: 'Medical Support',
    description: 'Accurate medical transcription services for healthcare professionals and facilities.',
    icon: '📋',
  },
  {
    name: 'Home Care',
    category: 'Health Facility',
    description: 'Professional healthcare support and services delivered in the comfort of your home.',
    icon: '🏠',
  },
  {
    name: 'Surgical Scrubs & Uniforms',
    category: 'Medical Apparel',
    description: 'Quality surgical scrubs and professional uniforms for healthcare personnel.',
    icon: '🥼',
  },
  {
    name: 'Medical Tourism',
    category: 'Healthcare Travel',
    description: 'Healthcare travel support connecting patients with specialized medical services.',
    icon: '✈️',
  },
  {
    name: 'Attentive Medical',
    category: 'Patient Care',
    description: 'Dedicated and attentive healthcare services focused on patient needs.',
    icon: '❤️',
  },
  {
    name: 'Nurturing Health Awareness',
    category: 'Health Education',
    description: 'Promoting better health through awareness, education, and preventive care.',
    icon: '📚',
  },
  {
    name: 'Drug Rehabilitation Facility',
    category: 'Rehabilitation',
    description: 'Supportive rehabilitation services designed to help individuals on their recovery journey.',
    icon: '🌿',
  },
];
...
<section className="py-32 bg-slate-50">
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="text-center max-w-3xl mx-auto mb-20">
      <h2 className="text-xs font-black uppercase tracking-[0.5em] text-emerald-600 mb-6">
        What We Offer
      </h2>
      ...
      <p className="mt-8 text-lg text-slate-500 font-medium leading-relaxed">
        From telemedicine and pharmaceutical delivery to home care and
        rehabilitation, we provide a wide range of healthcare solutions
    ...
    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      {products.map((product, i) => (
        <div
          key={i}
          className="group bg-white p-10 rounded-[3rem] border border-slate-100 hover:border-emerald-200 hover:shadow-2xl hover:shadow-emerald-100/40 transition-all duration-500 hover:-translate-y-2"
        >

          {/* Icon */}
          <div className="w-16 h-16 bg-emerald-50 rounded-2xl flex items-center justify-center text-3xl mb-8 group-hover:bg-emerald-600 group-hover:scale-110 transition-all duration-500">
            {product.icon}
          </div>
          ...
          {/* Title */}
          <h4 className="text-2xl font-black text-slate-900 mt-3 mb-4 group-hover:text-emerald-600 transition-colors">
            {product.name}
          </h4>
          ...
          <Link
            to="/contact"
            className="mt-7 inline-flex items-center text-emerald-600 font-black text-[10px] uppercase tracking-widest hover:translate-x-2 transition-transform"
          >
            Learn More
          ...
          <div className="space-y-10">
            <div>
              ...
              <p className="text-lg text-slate-500 font-medium leading-relaxed">
                Byinks Health platform provide patients with seamless access to their health records, AI-driven diagnostics, and instant consultant access.
              </p>
            </div>
      ...
      <footer className="py-32 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-bold text-slate-600">
              <li>Lagos, Nigeria</li>
              <li>+234 8023614681</li>
              <li>care@ekomedical.org</li>
              <li>byinkshealth@gmail.com</li>
            </ul>
          </div>
        </div>
      </footer>
